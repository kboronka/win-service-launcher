...
:Build
	...
	%SAR% -f.d  ".\WinServiceLauncher\bin\%CONFIG%\*.*" /q /svn
	%SAR% -f.d  ".\WinServiceLauncherSetup\bin\%CONFIG%\*.*" /q /svn
	%SAR% -f.d  ".\WinServiceLauncher\obj\%CONFIG%\*.*" /q /svn
	%SAR% -f.d  ".\WinServiceLauncherSetup\obj\%CONFIG%\*.*" /q /svn
